...
// Whether two initials are the same or close enough to be heard as a pair. The
// empty initial is never similar to anything, not even to itself: 有 you and 月
// yue share no consonant, they merely both lack one.
function sameInitialGroup(a, b) {
  if (!a || !b) {
    return false;
  }
  if (a === b) {
...
exports.parse = parse;
exports.sameInitialGroup = sameInitialGroup;
